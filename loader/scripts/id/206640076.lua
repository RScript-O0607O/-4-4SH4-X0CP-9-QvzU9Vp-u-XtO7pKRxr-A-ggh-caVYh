...
Window:Dialog({
        ...
        Tabs.Main:AddButton({
        Title = "Teleport To Safe Zone (Killer)",
        Description = "",
        Callback = function()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(workspace.Lobby.SpawnLocations.SpawnLocation.Position)
    end
    })
Tabs.Main:AddButton({
  Title = "Spin Wheel",
  ...
  Callback = function()
      local args = {
        [1] = workspace.PrizeWheel.WheelSpot
      }
      game:GetService("ReplicatedStorage").Network.Lobby.Tickets.TicketRequest:InvokeServer(unpack(args))
end
})
        Tabs.Main:AddButton({
        Title = "Complete Obby",
        Description = "",
        Callback = function()
    firetouchinterest(game.Players.LocalPlayer.Character.HumanoidRootPart,workspace.CurrentMap.Map.EndingTeleporterModel.Collider,0)
firetouchinterest(game.Players.LocalPlayer.Character.HumanoidRootPart,workspace.CurrentMap.Map.EndingTeleporterModel.Collider,1)
    end
    })
        Tabs.Main:AddButton({
        Title = "Unload Map (Play Next Round)",
        Description = "",
        Callback = function()
...
v:FireServer("d")
  ...
  local Toggle = Tabs.Main:AddToggle("Crash", {Title = "Lag Server", Default = false })
