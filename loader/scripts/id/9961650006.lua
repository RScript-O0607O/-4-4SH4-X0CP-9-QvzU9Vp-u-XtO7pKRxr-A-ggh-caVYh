...
Window:Dialog({
        ...
        Description = "",
        Callback = function()
firetouchinterest(game.Players.LocalPlayer.Character.HumanoidRootPart,workspace.Finish.Finish,0)
      firetouchinterest(game.Players.LocalPlayer.Character.HumanoidRootPart,workspace.Finish.Finish,1)
      wait()
      firetouchinterest(game.Players.LocalPlayer.Character.HumanoidRootPart,workspace.Spawn.Spawn,0)
      firetouchinterest(game.Players.LocalPlayer.Character.HumanoidRootPart,workspace.Spawn.Spawn,1)
    end
    })
local Toggle = Tabs.Main:AddToggle("Money", {Title = "Auto Farm", Default = false })
