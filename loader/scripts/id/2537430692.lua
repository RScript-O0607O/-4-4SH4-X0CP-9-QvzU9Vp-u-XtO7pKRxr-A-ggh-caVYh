...
local pos = workspace.Map.Classic.Button  
local ts = game:GetService('TweenService')
local plr = game.Players.LocalPlayer
local Char = plr.Character or plr.CharacterAdded:wait()
local t = ts:create(Char.Humanoid.RootPart,TweenInfo.new(0.005), {CFrame = workspace.Map.Classic.Button.CFrame}  )
t:Play()
wait(0.005)
local t1 = ts:create(Char.Humanoid.RootPart,TweenInfo.new(0.005), {CFrame = workspace.Map.Classic.Button.CFrame}  )
t1:Play()
wait(0.07)
game.Players.LocalPlayer.Character.Humanoid.PlatformStand = false
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = pos2
workspace.CurrentCamera.CameraType = Enum.CameraType.Custom
       elseif game.Players.LocalPlayer.Team.Name == "Spectating" or "Destroyer" then
   Fluent:Notify({
        Title = "Warning",
        Content = "This function is only for Towers.",
        Duration = 5
    })
   end
    end
  ...
  Tabs.Main:AddButton({
        ...
        Description = "",
        Callback = function()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(workspace.Map.Classic.SpectatorArea.Area.Position)
    end
    })
...
if game.Players.LocalPlayer.Character:FindFirstChild("Place Object") ~= nil then
local ohVector31 = mouse.Hit.p
game.Players.LocalPlayer.Character["Place Object"].Remote:FireServer(ohVector31)
end
elseif game.Players.LocalPlayer.Team.Name == "Towers" or "Spectating" then
    Fluent:Notify({
        Title = "Warning",
        Content = "This function is only for Destroyer.",
        Duration = 5
    })
end
    end)
