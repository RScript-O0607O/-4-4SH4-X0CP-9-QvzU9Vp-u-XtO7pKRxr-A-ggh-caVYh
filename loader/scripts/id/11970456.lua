...
Tabs.Main:AddButton({
        ...
        Description = "",
        Callback = function()
		game.Workspace.CameraPassThrough:Destroy()
		end
    })
	Tabs.Main:AddButton({
        Title = "Remove Balls",
...
Tabs.Main:AddButton({
  ...
  Description = "",
  Callback = function()
      firetouchinterest(game.Players.LocalPlayer.Character.HumanoidRootPart,workspace.PutOnSuit,0)
      firetouchinterest(game.Players.LocalPlayer.Character.HumanoidRootPart,workspace.PutOnSuit,1)
end
})
	Tabs.Main:AddButton({
        Title = "Remove Playbox",
        Description = "",
        Callback = function()
		game.Workspace.PlayJail:Destroy()
		end
    })
local Toggle = Tabs.Main:AddToggle("Clear", {Title = "Force Clear", Default = false })
