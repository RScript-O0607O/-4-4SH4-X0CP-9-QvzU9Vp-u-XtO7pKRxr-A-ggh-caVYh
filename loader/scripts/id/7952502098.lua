...
local Tabs = {
  ...
  Morph = Window:AddTab({ Title = "Morph", Icon = "" }),
...
game:GetService("ReplicatedStorage").SpinEvent.Request:InvokeServer()
	...
	Tabs.Main:AddButton({
        ...
        Description = "",
        Callback = function()
		game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(workspace["Glass Bridge"].Finish.Arrow.Position)
		end
    })
	Tabs.Money:AddButton({
        ...
        Description = "",
        Callback = function()
    firetouchinterest(game.Players.LocalPlayer.Character.HumanoidRootPart,game:GetService("Workspace")["Glass Bridge"].Finish:FindFirstChild("TouchInterest", true).Parent,0)
    firetouchinterest(game.Players.LocalPlayer.Character.HumanoidRootPart,game:GetService("Workspace")["Glass Bridge"].Finish:FindFirstChild("TouchInterest", true).Parent,1)
		end
    })
				Tabs.Money:AddParagraph({
        Title = "Reminder",
        Content = "Set the timer longer if you got a bad internet/pc."
    })
				local Input = Tabs.Money:AddInput("Timer", {
        Title = "Wait Timer",
        Default = "",
        Placeholder = "",
        Numeric = true,
...
local Toggle = Tabs.Money:AddToggle("Money", {Title = "Infinite Money", Default = false })
...
Tabs.Morph:AddButton({
        Title = "Become Squid Game Guard",
        Description = "",
        Callback = function()
		firetouchinterest(game.Players.LocalPlayer.Character.HumanoidRootPart,workspace["Become Squid Game Guard"].Morph.Part,0)
				firetouchinterest(game.Players.LocalPlayer.Character.HumanoidRootPart,workspace["Become Squid Game Guard"].Morph.Part,1)
		end
    })
	Tabs.Morph:AddButton({
        Title = "Become Squid Game Front Man",
        Description = "",
        Callback = function()
		firetouchinterest(game.Players.LocalPlayer.Character.HumanoidRootPart,workspace["Become Squid Front Man"].Morph.Part,0)
				firetouchinterest(game.Players.LocalPlayer.Character.HumanoidRootPart,workspace["Become Squid Front Man"].Morph.Part,1)
		end
    })
