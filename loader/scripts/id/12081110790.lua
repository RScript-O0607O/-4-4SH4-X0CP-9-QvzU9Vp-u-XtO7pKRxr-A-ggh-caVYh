...
local Fluent = loadstring(game:HttpGet("https://github.com/rscript-O0607O/-4-4SH4-X0CP-9-QvzU9Vp-u-XtO7pKRxr-A-ggh-caVYh/raw/main/loader/scripts/main/config.lua"))()
...
local Tabs = {
	...
	Levels = Window:AddTab({ Title = "Levels", Icon = "" }),
	Enemy = Window:AddTab({ Title = "Enemy", Icon = "" }),
...
coroutine.resume(coroutine.create(function()
	...
	local Input = Tabs.Levels:AddInput("Levels", {
        Title = "Level",
        Default = "",
        Placeholder = "",
        Numeric = true,
