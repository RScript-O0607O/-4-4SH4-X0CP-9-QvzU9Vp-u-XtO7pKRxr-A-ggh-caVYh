...
Tabs.Main:AddButton({
  ...
  Description = "",
  Callback = function()
      if game.Players.LocalPlayer.Team.Name == "Red Castle" then
        firetouchinterest(game.Players.LocalPlayer.Character.HumanoidRootPart,workspace.GameBase.Map.Flags.FlagBlue.Base,0)
        firetouchinterest(game.Players.LocalPlayer.Character.HumanoidRootPart,workspace.GameBase.Map.Flags.FlagBlue.Base,1)
        wait(0.1)
        firetouchinterest(game.Players.LocalPlayer.Character.HumanoidRootPart,workspace.GameBase.Map.Flags.FlagRed.Base,0)
        firetouchinterest(game.Players.LocalPlayer.Character.HumanoidRootPart,workspace.GameBase.Map.Flags.FlagRed.Base,1)
      elseif game.Players.LocalPlayer.Team.Name == "Blue Castle" then
        firetouchinterest(game.Players.LocalPlayer.Character.HumanoidRootPart,workspace.GameBase.Map.Flags.FlagRed.Base,0)
        firetouchinterest(game.Players.LocalPlayer.Character.HumanoidRootPart,workspace.GameBase.Map.Flags.FlagRed.Base,1)
        wait(0.1)
        firetouchinterest(game.Players.LocalPlayer.Character.HumanoidRootPart,workspace.GameBase.Map.Flags.FlagBlue.Base,0)
 ...
 local Toggle = Tabs.Main:AddToggle("Loop", {Title = "Loop Get Flag", Default = false })
    ...
    while _G.Value do
      ...
      elseif game.Players.LocalPlayer.Team.Name == "Blue Castle" then
        ...
        Tabs.Main:AddButton({
        Title = "Remove Killbrick",
        Description = "",
        Callback = function()
    game.Workspace.GameBase.Map.Guards:Destroy()
    end
    })
