...
local Toggle = Tabs.Main:AddToggle("Auto", {Title = "Auto Farm", Default = false })
...
Tabs.Main:AddButton({
  ...
  Tabs.Main:AddParagraph({
        Title = "Info",
        Content = "Equip the powerup in your inventory if you can't get the powerup"
    })
Tabs.Main:AddButton({
        Title = "Get Powerups",
        Description = "",
        Callback = function()
    firetouchinterest(game.Players.LocalPlayer.Character.HumanoidRootPart,workspace.Powerups.Powerup.Part,0)
firetouchinterest(game.Players.LocalPlayer.Character.HumanoidRootPart,workspace.Powerups.Powerup.Part,1)
    end
    })
