...
local Toggle = Tabs.Main:AddToggle("Money", {Title = "Infinite Money", Default = false })
	...
	local Toggle = Tabs.Main:AddToggle("Coffee", {Title = "Infinite Coffee", Default = false })
