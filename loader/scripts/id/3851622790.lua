...
Tabs.Main:AddParagraph({
    Title = "Reminder",
    Content = "Join the game to access more features!"
})
Tabs.Main:AddButton({
        Title = "Become The Stealthy",
        Description = "",
        Callback = function()
...
Tabs.Main:AddButton({
  Title = "Become The Guest (Required 10 Badges)",
  Description = "",
  Callback = function()
      local args = {
        [1] = "LinkedSword",
...
Tabs.Main:AddButton({
  Title = "Become The Hyper (Required 5 Badges)",
  Description = "",
  Callback = function()
      local args = {
        [1] = "Lollipop",
