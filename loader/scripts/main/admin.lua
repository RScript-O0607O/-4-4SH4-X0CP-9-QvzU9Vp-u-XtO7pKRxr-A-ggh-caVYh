...
do
    function Utility:Log(Type, Message)
        ...
        if Type == 'error' then
            print('[ RoAdmin ] Error: ' .. Message)
        elseif Type == 'log' then
            print('[ RoAdmin ] ' .. Message)
        elseif Type == 'warn' then
            print('[ RoAdmin ] Warning: ' .. Message)
        end
    end
    ...
    function Utility:EnableDragging(Frame, Parent)
        ...
        local Main = CoreGui:FindFirstChild('RoAdmin | .gg/eyEwHCVjQy').Main
    ...
    function Utility:Destroy()
        ...
        for _, UI in next, CoreGui:GetChildren() do
            if UI.Name == 'RoAdmin | .gg/eyEwHCVjQy' then
...
function Library:CreateWindow(Properties)
    ...
    local function Execute(String)
        ...
        local Command = assert(Commands[First], '[ RoAdmin ] Command Not Found: ' .. First)
